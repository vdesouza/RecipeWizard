...
public class RecipeSummaryLoaderActivity extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(RecipeSummaryLoaderActivity.this, RecipeSummaryActivity.class);
